...
2.a) The comment line can not have continuation lines (by '\')
...
5.d) Pascal   - the same as Args=Drops=                            [number]
                NOTE: Pascal can not be used together with Args
                      or Drops.
...
5.g) Rptcmt   - use comment from the specified entry point         [number]
                ...
                NOTE: Rptcmt can not point to another Rptcmt.
                      Also, Rptcmt can not refer to entry point
                      without a Comment.
